...
const DIO_PinMode_type PinsModeArray[TOTAL_PINS]=
{
	...
	KEYPAD_INPUT_PIN,		 /* Port B Pin 4 /ss*/
	KEYPAD_INPUT_PIN,		 /* Port B Pin 5 //mosi*/
	KEYPAD_INPUT_PIN,		 /* Port B Pin 6 /miso*/
	KEYPAD_INPUT_PIN,		 /* Port B Pin 7 clk*/
	OUTPUT,		 /* Port C Pin 0 */
	OUTPUT,		 /* Port C Pin 1 */
	OUTPUT,		 /* Port C Pin 2 */
	OUTPUT,		 /* Port C Pin 3 */
	...
	OUTPUT,		 /* Port D Pin 0 */
	OUTPUT,		 /* Port D Pin 1 */
    KEYPAD_OUTPUT_PIN,      /* Port D Pin 2 /INT0*/
	KEYPAD_OUTPUT_PIN,      /* Port D Pin 3 / INT1 */
	KEYPAD_OUTPUT_PIN,		 /* Port D Pin 4  OC1B*/
	KEYPAD_OUTPUT_PIN,		 /* Port D Pin 5 OC1A*/
